...
import Quadnode, { QuadrantName } from './quadnode';
...
function createQuad({
  ...
  return new Quadnode(bounds, maxEntities, maxDepth);
}
...
describe('Quadnode public API', () => {
  it('should be instanciable', () => {
    createQuad();
  });

  describe('Quadnode#isDivided', () => {
  ...
  describe('Quadnode#entitiesCount', () => {
...
describe('Quadnode internals', () => {
  function getNodes(quad: Quadnode) {
  ...
  describe('Quadnode#add after divide', () => {
